  ...
  return (
    <div className={`pt-20 min-h-screen relative overflow-hidden ${
      ...
      <style>{`
        ...
        .guideline-card {
          background: ${isDarkMode ? 'rgba(30,30,30,0.85)' : 'rgba(255,255,255,0.95)'};
          border-radius: 18px;
          padding: 2.1rem 1.5rem 1.6rem 1.4rem;
          display: flex;
          align-items: flex-start;
          gap: 1.05rem;
          box-shadow: ${isDarkMode ? '0 6px 44px -10px #0005, 0 2px 22px 0 #ffffff15' : '0 8px 32px -8px rgba(0,0,0,0.15), 0 4px 20px 0 rgba(0,0,0,0.08)'};
          border: 1.7px solid ${isDarkMode ? 'rgba(255,255,255,0.15)' : 'rgba(0,0,0,0.08)'};
        ...
        .guideline-card:hover, .guideline-card:focus {
          box-shadow: ${isDarkMode ? '0 12px 54px -8px #ffffff20, 0 6px 38px 0 #8f3fff40' : '0 20px 60px -12px rgba(0,0,0,0.25), 0 8px 32px 0 rgba(0,0,0,0.12)'};
          border: 1.7px solid ${isDarkMode ? '#fff176d5' : 'rgba(99, 102, 241, 0.3)'};
        ...
        .gi-icon {
          ...
          line-height: 1.1;
          border-radius: 50%;
          background: ${isDarkMode ? 'rgba(255,255,255,0.12)' : 'rgba(99, 102, 241, 0.08)'};
          margin-right: 0.25rem;
          margin-top: 0.07rem;
          box-shadow: ${isDarkMode ? '0 0 16px 2px #fffbe750' : '0 4px 20px rgba(99, 102, 241, 0.15)'};
          padding: .5rem .65rem;
        ...
        .gi-title {
          ...
          margin-bottom: .33rem;
          letter-spacing: -.01em;
          text-shadow: ${isDarkMode ? '0 1px 6px #21212113' : 'none'};
        }

        .gi-desc {
          font-size: 1.08rem;
          color: ${isDarkMode ? 'rgba(255,255,255,.75)' : '#4b5563'};
          font-weight: 400;
          line-height: 1.55;
        }

        .guideline-emoji-glow {
          filter: ${isDarkMode ? 'drop-shadow(0 0 20px #fff176) drop-shadow(0 2px 36px #ffecb3)' : 'drop-shadow(0 4px 12px rgba(99, 102, 241, 0.3))'};
          animation: pulseGlow 2.1s infinite alternate;
        }

        @keyframes pulseGlow {
          0% { filter: ${isDarkMode ? 'drop-shadow(0 0 15px #fff176) drop-shadow(0 0 16px #ffecb3)' : 'drop-shadow(0 4px 12px rgba(99, 102, 241, 0.3))'}; }
          100% { filter: ${isDarkMode ? 'drop-shadow(0 0 35px #fff8) drop-shadow(0 0 36px #ffd77673)' : 'drop-shadow(0 8px 24px rgba(99, 102, 241, 0.4))'}; }
        }
        ...
        @keyframes elevate {
          0%, 100% {
            box-shadow: ${isDarkMode ? '0 4px 20px rgba(255, 255, 255, 0.1)' : '0 4px 20px rgba(0, 0, 0, 0.1)'};
            transform: translateY(0px);
          }
          50% {
            box-shadow: ${isDarkMode ? '0 12px 40px rgba(255, 255, 255, 0.15)' : '0 12px 40px rgba(0, 0, 0, 0.15)'};
        ...
        .card-hover:hover {
          ...
          box-shadow: ${isDarkMode ? '0 25px 70px rgba(255, 255, 255, 0.1)' : '0 25px 70px rgba(0, 0, 0, 0.2)'};
        }
        ...
        .team-card-hover:hover {
          ...
          box-shadow: ${isDarkMode ? '0 30px 80px rgba(255, 255, 255, 0.15)' : '0 30px 80px rgba(0, 0, 0, 0.25)'};
        }
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <h1
            ...
            style={{
              ...
              textShadow: isDarkMode ? 'none' : '0 4px 12px rgba(0,0,0,0.3)'
            }}
          >
            About{' '}
            <span
          ...
          >
            {[
              ...
              <div
                key={idx}
                className={`card-hover elevating backdrop-blur-2xl py-8 px-6 rounded-3xl border-2 cursor-pointer ${
                  isDarkMode 
              ...
              >
                ...
                <div className={`text-3xl sm:text-4xl font-black mb-2 ${
                  isDarkMode ? 'text-gray-100 drop-shadow-lg' : 'text-white drop-shadow-lg'
                }`}>
                  {stat.number}
                </div>
      ...
      <div className="py-24 px-8 pb-20 w-full z-10">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-16">
            ...
            <h2 className={`text-5xl font-black m-0 tracking-tight drop-shadow-lg ${
              isDarkMode ? 'text-gray-100' : 'text-gray-900'
            }`}>
              Perfect Dog Photo Tips
            </h2>
            <div className={`mt-4 mx-auto text-xl max-w-2xl font-normal leading-relaxed ${
      ...
      {/* Privacy Section */}
      <div className={`py-24 px-8 backdrop-blur-2xl relative z-10 border-t-2 border-b-2 ${
        isDarkMode 
          ? 'bg-gray-900 bg-opacity-30 border-gray-700 border-opacity-20' 
          : 'backdrop-blur-xl bg-slate-100/60 text-gray-800 border border-slate-300/40 hover:bg-slate-200/70 transition-all'
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className={`text-4xl sm:text-5xl md:text-6xl font-black mb-4 drop-shadow-xl ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                ...
                } backdrop-blur-2xl p-10 rounded-3xl border-2 text-center opacity-0 ${
                  isDarkMode 
                    ? 'bg-gray-800 bg-opacity-60 border-gray-600 border-opacity-30' 
                    : 'bg-white bg-opacity-95 border-gray-200 border-opacity-40'
                }`}
                style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                ...
                } backdrop-blur-2xl p-10 rounded-3xl border-2 opacity-0 ${
                  isDarkMode 
                    ? 'bg-gray-800 bg-opacity-60 border-gray-600 border-opacity-30' 
                    : 'bg-slate-100/70 backdrop-blur-2xl border border-slate-300/40 text-gray-800 hover:bg-slate-200/80 hover:border-slate-400/50 hover:shadow-lg transition-all'
                  ...
                  {tech.features.map((feature, fidx) => (
                    <div
                      ...
                      className={`py-3 px-4 rounded-xl text-sm flex items-center gap-3 border transition-all duration-300 hover:translate-x-2 ${
                        isDarkMode 
                          ? 'bg-gray-700 bg-opacity-40 text-gray-200 border-gray-600 border-opacity-20 hover:bg-gray-600 hover:bg-opacity-50' 
      ...
      {/* CTA Section */}
      <div className={`py-24 px-8 backdrop-blur-3xl relative z-10 border-t-2 overflow-hidden ${
        isDarkMode 
          ? 'bg-gray-900 bg-opacity-50 border-gray-700 border-opacity-30' 
          : 'bg-gradient-to-br from-indigo-400 to-purple-700'
      }`}>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h2 className={`text-4xl sm:text-5xl md:text-6xl font-black mb-6 drop-shadow-xl leading-tight ${
